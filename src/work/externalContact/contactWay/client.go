...
import (
	...
	request2 "github.com/px94/PowerWeChat/v3/src/work/externalContact/contactWay/request"
	response3 "github.com/px94/PowerWeChat/v3/src/work/externalContact/contactWay/response"
)
