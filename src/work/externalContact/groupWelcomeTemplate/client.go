...
import (
	...
	"github.com/px94/PowerWeChat/v3/src/work/externalContact/groupWelcomeTemplate/request"
	"github.com/px94/PowerWeChat/v3/src/work/externalContact/groupWelcomeTemplate/response"
)
