...
import (
	...
	"github.com/px94/PowerWeChat/v3/src/work/externalContact/customerStrategy/request"
	"github.com/px94/PowerWeChat/v3/src/work/externalContact/customerStrategy/response"
)
