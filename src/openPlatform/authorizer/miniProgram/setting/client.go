...
import (
	...
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/request"
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/response"
)
