...
import (
	...
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/tester/request"
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/tester/response"
)
