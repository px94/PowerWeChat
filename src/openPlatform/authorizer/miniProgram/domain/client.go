...
import (
	...
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/request"
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/response"
)
