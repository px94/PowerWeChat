...
import (
	...
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/privacy/request"
	"github.com/px94/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/privacy/response"
)
