...
import (
	...
	"github.com/px94/PowerWeChat/v3/src/basicService/subscribeMessage/request"
	response3 "github.com/px94/PowerWeChat/v3/src/basicService/subscribeMessage/response"
	"github.com/px94/PowerWeChat/v3/src/kernel"
	response2 "github.com/px94/PowerWeChat/v3/src/kernel/response"
	"github.com/px94/PowerWeChat/v3/src/officialAccount/device/response"
)
